...
export default function Row(props:RowProps) {
  const [position, setPosition] = useState<VariantProps<typeof displayRowStyle>["position"]>();
  const [bold, setBold] = useState<VariantProps<typeof displayRowStyle>["bold"]>();
  const [italic, setItalic] = useState<VariantProps<typeof displayRowStyle>["italic"]>();
  const [intent, setIntent] = useState<VariantProps<typeof displayRowStyle>["intent"]>('p');
  ...
  const intents:VariantProps<typeof displayRowStyle>["intent"][] = ["h1", "h2", "h3", "h4", "h5", "h6", "p"];  
